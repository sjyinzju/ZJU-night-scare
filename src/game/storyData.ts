...
export const storyScenes: Record<StorySceneId, StoryScene> = {
  ...
  library_police: {
    ...
    setting: "indoor",
    body: [
      "你走到医学院图书馆出口门前。门外的红蓝灯隔着玻璃一阵阵扫进来，把书架、楼梯和地上的水痕切成短促的明暗。二十分钟后，救护车和警车呼啸而至，医学院教学楼下拉起了警戒线。",
  ...
  dorm_baiqiu: {
    ...
    setting: "outdoor",
    body: [
      "从医学院图书馆出来时，雨已经把校园洗成一层发亮的黑。借阅小票贴在湿透的口袋里，那张从封条后取下的符纸隔着衣料一阵阵发烫。直到白沙宿舍的门禁灯出现在雨幕里，你才发现整片宿舍区安静得反常：没有外卖车，没有说话声，本该亮着的窗口也像被谁逐层按灭。你刚抬起校园卡，身后忽然有人叫你的名字。",
