...
export const storyScenes: Record<StorySceneId, StoryScene> = {
  library_intro: {
    ...
    setting: "indoor",
    body: [
      "2008年3月初，深夜。紫金港校区的路灯在雾气里发着模糊的光。你叫张超，生命科学大三，住白沙 2 幢 123。成绩不好不坏，平时爱打游戏，只有考试前才抱佛脚。年前挂了一门，这星期要补考。基础图书馆九点关门，你只好跟着室友林伟，来到西南角的医学院图书馆——农医馆。",
      ...
      "林伟说医学院图书馆晚上人少，补考前正好清静。可馆里那台借阅机一直亮着。旧帖子里有人写过：每年总有一晚，系统会多出一条不存在的借阅记录——借阅人姓名为空，归还地点却写着医学院地下仓库。林伟一开始还笑，说这像学长学姐编出来吓新生的故事。",
  ...
  dorm_baiqiu: {
    ...
    setting: "outdoor",
    body: [
      "回到白沙 2 幢楼下，正要刷卡进门，一个熟悉的声音叫住了你。「张超！」回头一看，是女朋友白秋。她穿着一件红色羽绒服，站在下面，白皙的脸上似受了冻，有些苍白。白秋是经济系的，住在对面白沙 3 幢，中间隔着白沙小广场。性格偏冷淡，两人从大一就认识，却都爱窝寝室，平时并不是天天黏在一起。这么晚还等在这里，你已经觉得不对劲。",
