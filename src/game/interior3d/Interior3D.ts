...
export class Interior3D {
  ...
  private update(dt: number): void {
    ...
    // Follow the floor (0 on the ground, or the spiral ramp / gallery height).
    this.camera.position.y = this.room.floorHeightAt(this.camera.position.x, this.camera.position.z) + EYE_HEIGHT;
